       ...
       PROGRAM-ID. PROJ-ADD-RCT.
       ENVIRONMENT DIVISION.
       INPUT-OUTPUT SECTION.
       FILE-CONTROL.
            SELECT RC-FILE-DESC ASSIGN TO 'RC-FILE-DESC.CPY'
       ...
       DATA DIVISION.
       FILE SECTION.
       FD RC-FILE-DESC IS EXTERNAL RECORD CONTAINS 37 CHARACTERS.
       COPY RC-FILE-DESC.
       ...
       200-INPUT-ROUTINE.
           ...
           MOVE 1 TO WS-KEY
           READ RC-FILE-DESC
           MOVE RC-DATA-REC TO RC-EOF-REC
           MOVE RC-EOF TO WS-TMP-EOF-PNTR
           ADD 1 TO RC-EOF
           REWRITE RC-DATA-REC FROM RC-EOF-REC
